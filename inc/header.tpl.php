...
<head>
  ...
  <title>Espace privé</title>
      ...
      <header class="left">
        <nav class="left__nav">
          <ul>
            <li <?php if ($currentPage == 'acceuil') {echo ' id="en-cours"';} ?>class="left__nav-item left__nav-link:hover"><a  href="privatespace.php?page=acceuil" class="left__nav-link">Acceuil</a></li>
            ...
            <li <?php if ($currentPage == 'déconnexion') {echo ' id="en-cours"';} ?>class="left__nav-item left__nav-link:hover"><a href="privatespace.php?page=déconnexion" class="left__nav-link">Déconnexion</a></li>
          </ul>
        </nav>
      </header>
